...
public class ReturnComputerViewController implements Controller {
  ...
  @FXML
  private TableView<ReturnComputerViewModel.StudentLoanData> studentLaptopTable;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> viaIdColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> studentNameColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> emailColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> phoneColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> laptopBrandColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> laptopModelColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> laptopSpecsColumn;
  @FXML
  private TableColumn<ReturnComputerViewModel.StudentLoanData, String> loanDateColumn;
  @FXML
  ...
  private void setupListeners() {
    ...
    searchTypeComboBox.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
      if (newVal != null) {
        viewModel.searchTypeProperty().set(newVal);
      }
    });
