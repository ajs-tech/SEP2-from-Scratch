...
public class StudentLaptopViewController implements Controller {
  ...
  // Laptop tabeller
  @FXML
  private TableView<StudentLaptopViewModel.LaptopData> highPerformanceLaptopsTable;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> highLaptopBrandColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> highLaptopModelColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, Number> highLaptopRamColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, Number> highLaptopDiskColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> highLaptopStatusColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> highLaptopStudentColumn;

  @FXML
  private TableView<StudentLaptopViewModel.LaptopData> lowPerformanceLaptopsTable;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> lowLaptopBrandColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> lowLaptopModelColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, Number> lowLaptopRamColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, Number> lowLaptopDiskColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> lowLaptopStatusColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.LaptopData, String> lowLaptopStudentColumn;

  // Venteliste tabeller
  @FXML
  private TableView<StudentLaptopViewModel.StudentData> highPerformanceQueueTable;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> highQueueViaIdColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> highQueueNameColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> highQueueEmailColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> highQueuePhoneColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> highQueueDateColumn;

  @FXML
  private TableView<StudentLaptopViewModel.StudentData> lowPerformanceQueueTable;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> lowQueueViaIdColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> lowQueueNameColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> lowQueueEmailColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> lowQueuePhoneColumn;
  @FXML
  private TableColumn<StudentLaptopViewModel.StudentData, String> lowQueueDateColumn;
